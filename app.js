...
const recipes = {
  ...
  goblin_rose_troll: {
    ...
    description: "После пары капель слышно даже то, что о тебе шепчут в другом конце лавки.",
    image: "zelieushey.png",
  },

  goblin_rose_scale: {
    name: "Зелье «Сытость»",
    description: "Дарит ощущение плотного обеда на несколько часов. Организм всё равно помнит, что ты жрёшь плохо.",
